...
# The overall class was made by Marcus, I have added code for the portions I wrote
class FillerDetector(nn.Module):
    def __init__(self, bundle=pipelines.WAV2VEC2_BASE, out_dim=2, train_transfer_model=False, hidden_dim=256):
        ...
        # The below lines in this method are Andrew written
    ...
    # This is originally from my wav2vec2_model.py script
