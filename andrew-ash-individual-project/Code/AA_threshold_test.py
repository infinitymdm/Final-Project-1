...
# Yet another plotting script with boilerplate written by ChatGPT that I (Andrew)
# then edited throughout for the desired formatting and directory structures.
